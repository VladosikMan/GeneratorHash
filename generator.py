...
def get_var_str(x):
    ...
    if x == 10 :
        return "Реализовать алгоритм криптографической функции – Blake2b. На входе сообщение произвольный длины.Размер хеша – 512 бит. Оценить быстродействие по сравнению с другими хэш-функциями, разработанными в тот период."


    if x == 11 :
        return "Реализовать алгоритм кодирования двоичных данных – Base64. На входе сообщение произвольный длины. Оценить быстродействие по сравнению с другими алгоритами кодирования."
